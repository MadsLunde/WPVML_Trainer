...
{
    public class SdcaMaximumEntropy
    {
        private static MLContext mlContext = new MLContext(seed: 1);
        private static string MODEL_FILEPATH = @"../../../../WPVML_TrainerML.Model/SdcaMaximumEntropy.zip";
        ...
        {
            List<MostImportantPage> result = new List<MostImportantPage>();
            ...
            {
                result.Add(MostImportantPageMapper.Map(session));
            }

            IDataView trainingDataView = mlContext.Data.LoadFromEnumerable(result);
        ...
        {
            IEstimator<ITransformer> dataProcessPipeline = mlContext.Transforms.Conversion
                .MapValueToKey(outputColumnName: "Label", inputColumnName: "MostImportantPage")
                .Append(mlContext.Transforms.Categorical.OneHotEncoding(outputColumnName: "LatitudeEncoded", inputColumnName:"Latitude"))
                ...
                .Append(mlContext.Transforms.Concatenate("Features", "HourEncoded", "DayEncoded", "LatitudeEncoded", "LongitudeEncoded", "TemperatureEncoded"));
